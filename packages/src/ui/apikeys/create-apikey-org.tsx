...
// import { PersonalAccountView } from '../shared/personal-account';
// import { type SettingsCardClassNames } from '../shared/settings-card';
// import { useAuth, useAuthHooks } from '@/hooks';
// // import { OrganizationCellView } from '../cards/organization-cell-view';
...
// export function CreateApiKeyDialogOrg({
//   classNames,
...
//     name: z
//       .string()
//       .min(1, { error: `${localization.NAME} ${localization.IS_REQUIRED}` }),
//     expiresInDays: z.string().optional(),
//     organizationId: showOrganizationSelect
//       ? z.string().min(1, {
//         error: `${localization.ORGANIZATION} ${localization.IS_REQUIRED}`,
//       })
//       : z.string().optional(),
//   });
