export default function TermsPage() {
  return (
    <main className="container flex flex-col gap-4 self-center p-4 text-sm md:p-6">
      ...
      <p>
        This website is operated by Better Auth Starter. Throughout the site, the terms “we”, “us”
        and “our” refer to Better Auth Starter. Better Auth Starter offers this website, including
      ...
      <p>
        ...
        which the service is provided, without express written permission by us. The headings used
        in this agreement are included for convenience only and will not limit or otherwise affect
        these Terms.
      </p>
      ...
      <p>
        ...
        according to our Return Policy. To view our Return Policy, please visit the Return Policy
        page.
      </p>
      ...
      <p>
        ...
        publish, distribute, translate and otherwise use in any medium any comments that you forward
        to us.
      </p>
      ...
      <p>
        ...
        To view our Privacy Policy, please see the Privacy Policy page.
      </p>
      ...
      <ul>
        ...
        <li>
          (k) to interfere with or circumvent the security features of the Service or any related
      ...
      <p>
        ...
        use, without any representation, warranties or conditions of any kind, either express or
      ...
      <p>
        In no case shall Better Auth Starter, our directors, officers, employees, affiliates,
        ...
        of any of the service or any products procured using the service, or for any other claim
        related in any way to your use of the service or any product, including, but not limited to,
      ...
      <p>
        You agree to indemnify, defend and hold harmless Better Auth Starter and our parent,
      ...
      <p>
        ...
        or the Service following the posting of any changes constitutes acceptance of those changes.
      </p>
    </main>
  );
}
