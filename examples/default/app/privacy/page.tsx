  ...
  return (
    <main className="container flex flex-col gap-4 self-center p-4 text-sm md:p-6">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Better Auth Starter, the software program
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Better Auth Starter.
          </p>
        </li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Better Auth Starter, accessible from{' '}
            <a
